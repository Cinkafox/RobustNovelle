...
public class GameplayStateBase : State, IEntityEventSubscriber
{
    ...
    public IEnumerable<EntityUid> GetClickableEntities(MapCoordinates coordinates)
    {
        ...
        var entities = spriteTree.QueryAabb(coordinates.MapId,
        ...
        foreach (var entity in entities)
            if (clickQuery.TryGetComponent(entity.Uid, out var component) &&
                component.CheckClick(entity.Component, entity.Transform, xformQuery, coordinates.Position, eye,
                    out var drawDepthClicked, out var renderOrder, out var bottom))
    ...
    private sealed class
        ClickableEntityComparer : IComparer<(EntityUid clicked, int depth, uint renderOrder, float bottom)>
    {
