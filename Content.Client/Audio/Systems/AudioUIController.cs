...
public sealed class AudioUIController : UIController
{
    ...
    public override void Initialize()
    {
        ...
        _configManager.OnValueChanged(CCVars.CCVars.UIClickSound, SetClickSound, true);
        _configManager.OnValueChanged(CCVars.CCVars.UIHoverSound, SetHoverSound, true);

        _configManager.OnValueChanged(CCVars.CCVars.InterfaceVolume, SetInterfaceVolume, true);
    }
