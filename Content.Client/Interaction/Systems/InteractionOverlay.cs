...
public sealed partial class InteractionOverlay : Overlay
{
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        while (query.MoveNext(out var interactionComponent))
        {
            ...
            handle.DrawRect(
                UIBox2.FromDimensions(startPos - new Vector2(5) - new Vector2(20, 0),
                    size + new Vector2(5 * 2) + new Vector2(20 * 2, 0)), Color.FromHex("#22222299"));
            handle.DrawRect(
                UIBox2.FromDimensions(startPos - new Vector2(5) - new Vector2(10, 0),
                    size + new Vector2(5 * 2) + new Vector2(10 * 2, 0)), Color.FromHex("#222222CC"));
            handle.DrawRect(UIBox2.FromDimensions(startPos - new Vector2(5), size + new Vector2(5 * 2)),
