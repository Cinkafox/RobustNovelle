...
/// <summary>
///     If the viewport is allowed to freely scale, this determines which dimensions should be ignored while fitting the
///     viewport
/// </summary>
public enum ScalingViewportIgnoreDimension
{
    ...
    /// <summary>
    ///     The viewport will ignore the horizontal dimension, and will exclusively consider the vertical dimension for
    ///     scaling.
    /// </summary>
    Horizontal,

    /// <summary>
    ///     The viewport will ignore the vertical dimension, and will exclusively consider the horizontal dimension for
    ///     scaling.
    /// </summary>
    Vertical
}